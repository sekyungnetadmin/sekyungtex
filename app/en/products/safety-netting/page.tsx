...
export const metadata: Metadata = {
  title: 'Industrial Safety Nets | Construction Fall Protection | SekyungNET Korea',
  description: 'Industrial-grade safety nets for construction fall protection, soccer, futsal, and debris containment. Manufactured in Korea to KS and ISO standards.',
  keywords: ['industrial safety net','construction fall protection net','soccer net','futsal net','debris net','safety netting korea'],
  alternates: { canonical: 'https://sekyungtex.co.kr/en/products/safety-netting' },
}

const applications = ['Soccer goal nets & field surrounds','Futsal court ball-stop netting','Construction site fall protection','Debris containment nets','Crane & tower enclosure nets','Wind protection screens']

const features = [
  'High load-bearing capacity for fall protection',
  'KS / ISO certified performance standards',
  'UV and weather resistant for outdoor use',
  'Flame-retardant options available',
  'Custom cut to site specifications',
  'Official test reports issued on request',
]

const specs = [
  {label:'Material',value:'HDPE / Polypropylene'},
  {label:'Mesh size',value:'80mm – 200mm (custom)'},
  {label:'Color',value:'Orange, Green, Black'},
  {label:'Treatment',value:'UV-stabilized, flame-retardant available'},
  {label:'Size',value:'Custom cut to order'},
  {label:'Lead time',value:'1–3 weeks'},
]

const materials = [
  {name:'HDPE (High-Density Polyethylene)',tag:'Most Popular',tagColor:'bg-[#e8c840] text-[#111]',desc:'High-density polyethylene for construction safety, sports nets, and general safety applications. High strength-to-weight ratio and excellent UV resistance.',props:['High strength','UV-resistant','Lightweight','Wide application'],use:'Construction sites · Soccer · Futsal · Debris nets'},
  {name:'Polypropylene (PP)',tag:'',tagColor:'',desc:'Flame-retardant polypropylene for applications with strict fire safety requirements. Maintains structural integrity in high-temperature environments.',props:['Flame retardant','Chemical resistant','Heat tolerant',],use:'Fire-risk environments · Industrial facilities'},
]

const faqs = [
  {q:'What is this netting used for?',a:'Our safety netting is used across a wide range of applications including soccer goal nets, futsal court ball-stop netting, construction site fall protection, and debris containment nets.'},
  {q:'Are flame-retardant nets available?',a:'Yes, flame-retardant treated safety nets are available for applications with fire safety requirements.'},
...
const otherProducts = [
  ...
  {name:'Safety Netting',href:'/en/products/safety-netting',active:true},
...
export default function SafetyNettingPage() {
  return (
    <main className="bg-white text-sm">
      <section className="bg-[#1a2332] w-full relative overflow-hidden px-6 py-14" style={{backgroundImage:`linear-gradient(rgba(26,35,50,0.82),rgba(26,35,50,0.82)),url(/assets/safety1.jpg)`,backgroundSize:'60%',backgroundPosition:'center center'}}>
        
        <div className="relative max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-[1fr_300px] gap-8 md:gap-12 items-center">
          <div>
            <p className="text-[11px] tracking-[0.12em] text-[#e8c840] font-medium mb-3">PRODUCTS · INDUSTRIAL SAFETY</p>
            <h1 className="text-[34px] font-bold text-white leading-tight mb-3">Industrial<br/>Safety Netting</h1>
            <p className="text-[14px] text-[#8fa3bb] leading-relaxed mb-6 max-w-xl">Heavy-duty safety nets for <strong className="text-white font-medium">construction sites, soccer, futsal, and industrial facilities</strong>. KS/ISO certified to international safety standards.</p>
          ...
          <div className="hidden md:block bg-white/5 border border-white/10 rounded-xl p-5">
            ...
            {[{l:'Material',v:'HDPE / Polypropylene'},{l:'Mesh size',v:'35–200mm custom'},{l:'Lead time',v:'1–3 weeks'},{l:'Certification',v:'KS · ISO'}].map((row)=>(
      ...
      <section className="bg-white w-full border-b border-gray-200 px-6 py-2.5">
        <nav className="max-w-7xl mx-auto flex gap-1.5 text-[12px] text-gray-400">
          ...
          <span className="text-gray-900">Industrial Safety Netting</span>
        </nav>
      </section>
          ...
          <div className="border-r-0 lg:border-r border-gray-200">
            <div className="bg-white px-8 py-6 border-b border-gray-100">
              <div className="relative w-full h-64 rounded-lg overflow-hidden">
                <Image src="/assets/sports2.jpg" alt="Industrial safety netting by SekyungNET" fill className="object-cover object-center"/>
              </div>
            </div>
            <div className="bg-white px-8 py-6 border-b border-gray-100">
